...
public class QwirkleTestUtils {
     ...
     */
    public static Tile get(Grid grid, int row, int col) {
        return grid.getTile(INITIAL_ROW + row, INITIAL_COLUMN + col);
    }
     ...
     */
    public static void add(Grid grid, int row, int col, Tile tile) {
